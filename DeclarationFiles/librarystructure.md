...
针对每种主要的库的组织模式，在[模版](templete.md)一节都有对应的文件。 你可以利用它们帮助你快速上手。
...
使用[`module-function.d.ts`](https://www.tslang.cn/docs/handbook/declaration-files/templates/module-function-d-ts.html)，如果模块能够作为函数_调用_。
